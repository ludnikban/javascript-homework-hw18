...
function wordsList (stringToSplit, subStr)  {
...
let getLocalDate = (date, isSeconds, isISO) => {
  ...
  myDay = date.getDate() < 10 ? myDay = "0" + date.getDate() : myDay = date.getDate();
  myMounth = date.getMonth() +1 < 10 ? myMounth = '0'+ (date.getMonth() + 1) : myMounth = date.getMonth() + 1;
  myHours = date.getHours() < 10 ? myHours = "0" + date.getHours() : myHours = date.getHours();
  myMinutes = date.getMinutes() < 10 ? myMinutes = '0' + date.getMinutes() : myMinutes = date.getMinutes();
  mySeconds = date.getSeconds() < 10 ? mySeconds = '0' + date.getSeconds() : mySeconds = date.getSeconds();
  
  newDate =  myDay +"."+ myMounth+"."+ date.getFullYear() +", "+ myHours +":"+ myMinutes;
  
  if (isSeconds === true) {
    newDate =  myDay +"."+ myMounth+"."+ date.getFullYear() +", "+ myHours +":"+ myMinutes +':'+ mySeconds 
  }
    if (isSeconds === true && isISO === true) {
      newDate =  date.getFullYear() +'-'+ myMounth + '-' + myDay + ', ' + myHours +":"+ myMinutes +':'+ mySeconds
    }
    if (isSeconds === false && isISO === true) {
      newDate =  date.getFullYear() +'-'+ myMounth + '-' + myDay + ', ' + myHours +":"+ myMinutes 
    } 
    return newDate;
}
...
Car = function (engine, model, name, year) {
  	this.engine = engine;
    this.model = model;
    this.name = name;
    this.year = year;
...
let car  = new Car(1400, 'Getz', 'Hyundai', 2011);
let car1 = new Car(1600, 'Spaceback', 'Skoda', 2018);
let car2 = new Car(1500, 'Demio', 'Mazda', 2020);
...
function testPerformance(iterations, func) {
  ...
  for (var i = 1; i <= iterations; i++) func();
